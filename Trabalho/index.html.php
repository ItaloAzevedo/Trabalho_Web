...
<html class="no-js"  lang="pt-br">
	...
	<head>
		...
		<!-- TITLE OF SITE -->
		<title>Marie Curie - Clínica de traumatologia</title>
		...
		<section id="home" class="about-us">
			<div class="container">
				<div id="teste">
					...
					<form>
						 <div id="magic">
							<p align="left"><i><b class="ho">Informe CPF do paciente ou código do cartão</b></i></p>
							<select class="form-control col-sm-2 ga ho">
								  <option class="ho">CPF</option>
								<option class="ho">Código do cartão</option>
							</select>
							  <div class="col ho">
							  <input type="text" class="form-control col-sm-6 ge" placeholder="999.999.999.99 ou 9999999">
							</div>
							<i><b class="ho">Data de nascimento</b></i>
							<input type="date" class="form-control col-sm-6 ho" name="d_m_a">
							<p id="email" class="ho" align="left"><i><b>E-mail</b></i></p>
							<input class="form-control col-sm-8 ho" type="text" placeholder="mcct@provedor.com">
							<p align="left"><i><b class="ho">Confirme o e-mail</b></i></p>
							<input class="form-control col-sm-8 ho" type="text" placeholder="mcct@provedor.com">
							<label for="inputPassword5"><i><b class="ho">Senha</b></i></label>
							<input type="password" id="inputPassword5" class="form-control col-sm-8 ho" aria-describedby="passwordHelpInline" placeholder="sua senha deve conter entre 8-20 caracteres">
							<small id="passwordHelpBlock" class="form-text text-muted ho">
							</small>
							<label for="inputPassword5"><i><b class="ho">Confirme a senha</b></i></label>
							<input type="password" id="inputPassword5" class="form-control col-sm-8 ho" aria-describedby="passwordHelpInline">
							  <div class="form-group row ho">
										<div class="col-sm-10 ho">
										  <div class="form-check ho">
												<input class="form-check-input ho" type="checkbox" id="gridCheck1">
													<label class="form-check-label ho" for="gridCheck1">
														<i><b class="ho">Deseja receber notícias e ofertas de nossos planos?</b></i>
													</label>
										  </div>
										</div>
								  </div>
				...
				<button type="submit" id= "cadastrar" class="btn btn-primary my-3 bt" name="cadastrar">Cadastrar-se</button>
			</div>
			</div><!--/.container-->
